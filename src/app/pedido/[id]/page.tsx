...
export default function Pedido({ params, search }: any) {
  console.log(params.id)
  return (
      <section className="py-24 mt-10 relative">
        <div className="w-full max-w-7xl px-4 md:px-5 lg-6 mx-auto">
            <h2 className="font-manrope font-bold text-4xl leading-10 text-black text-center">
                Pagamento Aprovado
            </h2>
            <p className="mt-4 font-normal text-lg leading-8 text-gray-500 mb-11 text-center">Obrigado por escolher ser <i>CACI.</i><br/>
                Você pode verificar os detalhes do seu pedido abaixo</p>
            <div className="main-box border border-gray-200 rounded-xl pt-6 max-w-xl max-lg:mx-auto lg:max-w-full">
                <div
                    ...
                    <div className="data">
                        <p className="font-semibold text-base leading-7 text-black">ID: <span className="text-indigo-600 font-medium">#10234987</span></p>
                        <p className="font-semibold text-base leading-7 text-black mt-4">Pagamento: <span className="text-gray-400 font-medium"> 18 de Março
                            de 2021</span></p>
                    </div>
                    <button
                        className="rounded-full py-3 px-7 font-semibold text-sm leading-7 text-white bg-black max-lg:mt-5 shadow-sm shadow-transparent transition-all duration-500 hover:bg-gray-800 hover:shadow-gray-700">Rastrear Pedido</button>
                </div>
                                ...
                                <div className="grid grid-cols-5">
                                    <div className="col-span-5 lg:col-span-1 flex items-center max-lg:mt-3">
                                        <div className="flex gap-3 lg:block">
                                            ...
                                            <p className="lg:mt-4 font-medium text-sm leading-7 text-green-600">$100</p>
                                        </div>
                                    </div>
                            ...
                            <div className="grid grid-cols-1 lg:grid-cols-2 w-full">
                                ...
                                <div className="grid grid-cols-5">
                                    <div className="col-span-5 lg:col-span-1 flex items-center max-lg:mt-3">
                                        <div className="flex gap-3 lg:block">
                                            <p className="font-medium text-sm leading-7 text-black">Preço</p>
                                            <p className="lg:mt-4 font-medium text-sm leading-7 text-green-600">R$ 149,90</p>
                                        </div>
                                    </div>
                                    <div className="col-span-5 lg:col-span-2 flex items-center max-lg:mt-3 ">
                                        <div className="flex gap-3 lg:block">
                ...
                <div className="w-full border-t border-gray-200 px-6 flex flex-col lg:flex-row items-center justify-between ">
                    <div className="flex flex-col sm:flex-row items-center max-lg:border-b border-gray-200">
                        ...
                        <p className="font-medium text-lg text-gray-900 pl-6 py-3 max-lg:text-center">Pago com Cartão de Crédito <span className="text-gray-500">de final 8822</span></p>
                    </div>
                    <p className="font-semibold text-lg text-black py-6">Total Price: <span className="text-indigo-600"> R$ 249.90</span></p>
                </div>
