        ...
        <section className="bg-white py-8 antialiased md:py-16">
            <div className="mx-auto max-w-screen-xl px-4 2xl:px-0">
                ...
                <div className="gap-4 sm:flex sm:items-center sm:justify-between">
                    <h2 className="text-xl font-semibold text-gray-800 sm:text-2xl">Seus Pedidos</h2>

                    <div className="mt-6 gap-4 space-y-4 sm:mt-0 sm:flex sm:items-center sm:justify-end sm:space-y-0">
                    <div>
                        <label htmlFor="order-type" className="sr-only mb-2 block text-sm font-medium text-gray-800">Status</label>
                        <select id="order-type" className="block w-full min-w-[8rem] rounded-lg border border-gray-300 bg-gray-50 p-2.5 text-sm text-gray-800 focus:border-primary-500 focus:ring-primary-500">
                            <option selected>Todos</option>
                            <option value="in-transit">Enviados</option>
                            <option value="confirmed">Completos</option>
                            <option value="cancelled">Cancelados</option>
                        </select>
                    </div>

                    <span className="inline-block text-gray-500"> Data: </span>

                    <div>
                        <label htmlFor="duration" className="sr-only mb-2 block text-sm font-medium text-gray-800 ">Select duration</label>
                        <select id="duration" className="block w-full rounded-lg border border-gray-300 bg-gray-50 p-2.5 text-sm text-gray-800 focus:border-primary-500 focus:ring-primary-500">
                        <option selected>Esta semana</option>
                        <option value="this-month">Este mês</option>
                        <option value="last-3-months">Últimos 3 meses</option>
                        <option value="lats-6-months">Últimos 6 meses</option>
                ...
                <div className="mt-6 flow-root sm:mt-8">
                    ...
                    <div className="flex flex-wrap items-center gap-y-4 py-6">
                        ...
                        <dl className="w-1/2 sm:w-1/4 lg:w-auto lg:flex-1">
                            ...
                            <dd className="mt-1.5 text-base font-semibold text-gray-800 ">20/12/2024</dd>
                        </dl>

                        <dl className="w-1/2 sm:w-1/4 lg:w-auto lg:flex-1">
                            <dt className="text-base font-medium text-gray-500">Total:</dt>
                            <dd className="mt-1.5 text-base font-semibold text-gray-800 ">R$ 460,75</dd>
                        </dl>
                    ...
                    <div className="flex flex-wrap items-center gap-y-4 py-6">
                        ...
                        <dl className="w-1/2 sm:w-1/4 lg:w-auto lg:flex-1">
                            <dt className="text-base font-medium text-gray-500">Data:</dt>
                            <dd className="mt-1.5 text-base font-semibold text-gray-800 ">11/12/2024</dd>
                        </dl>

                        <dl className="w-1/2 sm:w-1/4 lg:w-auto lg:flex-1">
                            <dt className="text-base font-medium text-gray-500">Total:</dt>
                            <dd className="mt-1.5 text-base font-semibold text-gray-800 ">R$ 499,00</dd>
                        </dl>
                    ...
                    <div className="flex flex-wrap items-center gap-y-4 py-6">
                        ...
                        <dl className="w-1/2 sm:w-1/4 lg:w-auto lg:flex-1">
                            <dt className="text-base font-medium text-gray-500">Data:</dt>
                            <dd className="mt-1.5 text-base font-semibold text-gray-800 ">08/12/2024</dd>
                        </dl>

                        <dl className="w-1/2 sm:w-1/4 lg:w-auto lg:flex-1">
                            <dt className="text-base font-medium text-gray-500">Total:</dt>
                            <dd className="mt-1.5 text-base font-semibold text-gray-800 ">R$ 149,90</dd>
                        </dl>
