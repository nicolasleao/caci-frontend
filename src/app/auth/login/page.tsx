  ...
  return (
    <div className="flex min-h-full flex-col justify-center px-6 py-12 lg:px-8">
      <div className="sm:mx-auto sm:w-full mt-10 sm:max-w-sm flex flex-col justify-center items-center">
        ...
        <h2 className="mt-5 text-center text-2xl/9 font-bold tracking-tight text-gray-900">Faça login na sua conta</h2>
      </div>
      ...
      <div className="mt-10 sm:mx-auto sm:w-full sm:max-w-sm">
          ...
          <div>
            <div className="flex items-center justify-between">
              ...
              <div className="text-sm">
                <a href="#" className="font-semibold text-blue-600 hover:text-blue-500">Esqueci minha senha</a>
              </div>
            </div>
            <div className="mt-2">
        ...
        <p className="mt-10 text-center text-sm/6 text-gray-500">
          Ainda não tem uma conta?&ensp;
          <a href="/auth/cadastro" className="font-semibold text-blue-600 hover:text-blue-500">Cadastre-se</a>
        </p>
      </div>
    </div>
  )
